    ...
    2: [function(t, s, l) {
      ! function(s, i) {
        ...
        s.prototype.init = function() {
          ...
          if (i.s.dynamic) {
            if (i.s.dynamicEl[e].poster && (o = !0, n = i.s.dynamicEl[e].poster), c = i.s.dynamicEl[e].html, r = i.s.dynamicEl[e].src, i.s.dynamicEl[e].responsive) {
              var f = i.s.dynamicEl[e].responsive.split(",");
              g(f)
            }
            a = i.s.dynamicEl[e].srcset, u = i.s.dynamicEl[e].sizes
          } else {
            if (i.items[e].getAttribute("data-poster") && (o = !0, n = i.items[e].getAttribute("data-poster")), c = i.items[e].getAttribute("data-html"), r = i.items[e].getAttribute("href") || i.items[e].getAttribute("data-src"), i.items[e].getAttribute("data-responsive")) {
          ...
          if (!l.default.hasClass(i.___slide[e], "lg-loaded")) {
            if (m) i.___slide[e].insertAdjacentHTML("afterbegin", '<div class="lg-video-cont" style="max-width:' + i.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + r + '"  allowfullscreen="true"></iframe></div></div>');
              ...
              var v = "";
              v = p && p.youtube ? "lg-has-youtube" : p && p.vimeo ? "lg-has-vimeo" : "lg-has-html5", i.___slide[e].insertAdjacentHTML("beforeend", '<div class="lg-video-cont ' + v + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + n + '" /></div></div>')
            ...
            if (l.default.trigger(i.el, "onAferAppendSlide", {
                index: e
              }), d = i.___slide[e].querySelector(".lg-object"), u && d.setAttribute("sizes", u), a) {
          ...
          if (!d.lGalleryOn || i !== e) {
            ...
            if (!d.lgBusy) {
              ...
              if (l.default.trigger(d.el, "onBeforeSlide", {
                ...
                e < i ? (u = !0, 0 !== e || i !== r - 1 || s || (u = !1, a = !0)) : e > i && (a = !0, e !== r - 1 || 0 !== i || s || (u = !0, a = !1)), u ? (l.default.addClass(this.___slide[e], "lg-prev-slide"), l.default.addClass(this.___slide[i], "lg-next-slide")) : a && (l.default.addClass(this.___slide[e], "lg-next-slide"), l.default.addClass(this.___slide[i], "lg-prev-slide")), setTimeout(function() {
